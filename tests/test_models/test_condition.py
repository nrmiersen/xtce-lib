...
from xtce_lib import DowngradePolicy, XtceDowngradeError, XtcePath, XtceVersion, xtce
...
class TestArgumentComparison:
    ...
    def test_round_trip_with_parameter_instance_ref(
        ...
        XTCE 1.1 has no ArgumentComparisonType, so this casts to ComparisonType.
    ...
    def test_v1_1_rejects_argument_instance_ref(self) -> None:
        """Verify an ArgumentInstanceRef cannot be cast down to XTCE 1.1."""
...
class TestArgumentComparisonCheck:
    ...
    def test_v1_1_rejects_argument_instance_ref_left(self) -> None:
        """Verify an ArgumentInstanceRef left side cannot be cast down to XTCE 1.1."""
        with pytest.raises(XtceDowngradeError):
    ...
    def test_v1_1_rejects_argument_instance_ref_right(self) -> None:
        """Verify an ArgumentInstanceRef right side cannot be cast down to XTCE 1.1."""
        with pytest.raises(XtceDowngradeError):
            xtce.ArgumentComparisonCheck(
                left=_make_parameter_instance_ref(),
                right=xtce.ArgumentInstanceRef(ref="ArgumentB"),
                comparison_operator=xtce.ComparisonOperator.EQ,
            ).to_xsdata(XtceVersion.V1_1)
    ...
    def test_round_trip_with_literal_right_side_v1_1(self, right: object) -> None:
        """Round-trip ArgumentComparisonCheck cast to XTCE 1.1's ComparisonCheckType."""
        original = xtce.ArgumentComparisonCheck(
            left=_make_parameter_instance_ref(),
            comparison_operator=xtce.ComparisonOperator.GT,
            right=right,  # type: ignore[arg-type]
    ...
    def test_round_trip_with_parameter_instance_ref_right_side_v1_1(self) -> None:
        """Round-trip ArgumentComparisonCheck with a parameter right side through v1.1."""
        original = xtce.ArgumentComparisonCheck(
            left=_make_parameter_instance_ref(),
            comparison_operator=xtce.ComparisonOperator.LTE,
            right=xtce.ParameterInstanceRef(
...
class TestConditionGroups:
    ...
    def test_argument_anded_conditions_round_trip_v1_1(self) -> None:
        """Round-trip ArgumentAndedConditions cast to XTCE 1.1's AndedConditionsType.

        XTCE 1.1 has no argument-specific conditions, so children must be restricted to
    ...
    def test_argument_ored_conditions_round_trip_v1_1(self) -> None:
        """Round-trip ArgumentOredConditions cast to XTCE 1.1's OredConditionsType."""
        original = xtce.ArgumentOredConditions(
            conditions=[
                xtce.ArgumentComparisonCheck(
                    left=_make_parameter_instance_ref(),
...
class TestBooleanExpressionWrappers:
    ...
    def test_argument_boolean_expression_round_trip_v1_1(
        self, comparison: object
    ) -> None:
        """Round-trip ArgumentBooleanExpression wrapper variants cast to XTCE 1.1."""
        original = xtce.ArgumentBooleanExpression(comparison=comparison)  # type: ignore[arg-type]
...
class TestMatchCriteria:
    ...
    def test_discrete_lookup_list_enforces_default_value_on_v1_1(self) -> None:
        """Verify v1.1 drops DiscreteLookupList defaults under IGNORE."""
        ...
        with pytest.raises(XtceDowngradeError):
            original.to_xsdata(XtceVersion.V1_1, DowngradePolicy.STRICT)

        raw_obj = original.to_xsdata(XtceVersion.V1_1, DowngradePolicy.IGNORE)

        assert [lookup.value for lookup in raw_obj.discrete_lookup] == [5]

    def test_discrete_lookup_list_round_trip_v1_1(self) -> None:
        """Round-trip DiscreteLookupList through XTCE v1.1 (no default_value support)."""
        original = xtce.DiscreteLookupList(
            lookups=[
                xtce.DiscreteLookup(
                    criteria=xtce.Comparison(
    ...
    def test_argument_match_criteria_round_trip_v1_1(self) -> None:
        """Round-trip ArgumentMatchCriteria cases cast to XTCE 1.1.

        XTCE 1.1 has no argument-specific match criteria, so children must be
        restricted to parameter instance references.
        ...
        list_criteria = xtce.ArgumentMatchCriteria(
            criteria=[
                _make_argument_comparison(1),
                xtce.ArgumentComparison(
                    instance_ref=xtce.ParameterInstanceRef(
                        ref=XtcePath("/TestSystem/ParameterB"),
                        instance=0,
                        use_calibrated_value=True,
                    ),
    ...
    def test_argument_discrete_lookup_round_trip_v1_1(self) -> None:
        """Round-trip ArgumentDiscreteLookup cast to XTCE 1.1's DiscreteLookup."""
        original = xtce.ArgumentDiscreteLookup(
            criteria=xtce.ArgumentComparison(
                instance_ref=_make_parameter_instance_ref(),
                comparison_operator=xtce.ComparisonOperator.EQ,
    ...
    def test_argument_discrete_lookup_list_enforces_default_value_on_v1_1(self) -> None:
        """Verify v1.1 drops ArgumentDiscreteLookupList defaults under IGNORE."""
        original = xtce.ArgumentDiscreteLookupList(
            lookups=[
                xtce.ArgumentDiscreteLookup(
                    criteria=xtce.ArgumentComparison(
    ...
    def test_argument_discrete_lookup_list_round_trip_v1_1(self) -> None:
        """Round-trip ArgumentDiscreteLookupList through XTCE v1.1."""
        original = xtce.ArgumentDiscreteLookupList(
            lookups=[
                xtce.ArgumentDiscreteLookup(
                    criteria=xtce.ArgumentComparison(
        ...
        round_tripped = xtce.ArgumentDiscreteLookupList.from_xsdata(
            original.to_xsdata(XtceVersion.V1_1),
            XtceVersion.V1_1,
        )
