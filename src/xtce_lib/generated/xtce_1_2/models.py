...
class ArgumentInputSetType:
    ...
    choice: list[InputParameterInstanceRefType | ArgumentInstanceRefType] = field(
        default_factory=list,
        metadata={
            "type": "Elements",
            "choices": (
...
class ParameterToSetType(ParameterRefType):
    ...
    choice: None | MathOperationType | str = field(
        default=None,
        metadata={
            "type": "Elements",
            "choices": (
...
class ErrorDetectCorrectType:
    ...
    choice: None | ChecksumType | Crctype | ParityType = field(
        default=None,
        metadata={
            "type": "Elements",
            "choices": (
